const musicUrl = 'https://opentdb.com/api.php?amount=5&category=12&difficulty=easy&type=multiple';
        ...
        shuffledAnswers.forEach(answer => {
            ...
            btn.addEventListener("click", () => {
                ...
                if (answer === q.correct_answer) {
                    btn.style.backgroundColor = "#98d498";//green
                    score++;//increment score when choosing a correct answer
                } else {
                    btn.style.backgroundColor = "#e86c5f";//red
                    qDiv.appendChild(correctDisplay);//displahy correct answer
                }
